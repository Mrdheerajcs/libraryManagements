...
namespace API.DataAccess
{
    public interface IDataAccess
    {
        ...
        void CreateNote(NoticeBoard noticeBoard);
        bool DeleteNoticeBoard(int NoticeId);
        IList<NoticeBoard> GetAllNotice();
        bool UpdateNoticeBoard(NoticeBoard noticeBoard, int id);
        IList<NoticeBoard> GetCNotes(int id);
    }
}