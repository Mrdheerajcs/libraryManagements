...
export class RegisterComponent {
    ...
    this.registerForm = fb.group(
      {
        ...
        ysq: fb.control('', [Validators.required]),
        ysa: fb.control('', [Validators.required])
      },
      {
  ...
  getSecurityQErrors() {
    if (this.YSQ.hasError('required')) return 'Field is requied!';
    return '';
  }
  getSecurityAErrors() {
    if (this.YSA.hasError('required')) return 'Field is requied!';
    return '';
  }
  ...
  get YSQ(): FormControl {
    return this.registerForm.get('ysq') as FormControl;
  }
  get YSA(): FormControl {
    return this.registerForm.get('ysa') as FormControl;
  }
}
